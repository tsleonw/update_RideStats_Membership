** see README.md for a more current version of this file **
...
1.  src/deploy.py -- this file automates the deployment of the system, creating the zip file and copying all files to either a production directory
    or a test directory (to test the deployment).
2.  src/hbc_Member.py -- represents a hbc member.  This class validates hbc members.
3.  src/member_Error.py
